...
const ValidacionService = {
  ...
  /**
   * Validar un campo individual según su tipo y nombre
   */
  validarCampo(campo) {
    ...
    // Si ya hay error de obligatorio, retornar inmediatamente
    ...
    if (valor) {
      switch (nombre) {
        ...
        case 'telefono':
          // Quitar máscara para validar solo los 10 números puros
        ...
        case 'fecha_nacimiento':
          ...
          // Ajuste si no ha cumplido años este año aún
        ...
        case 'confirmar_password':
          const passwordOriginal = document.querySelector('[name="password"]').value;
  ...
  /**
   * Evaluar la fuerza de la contraseña (0 a 5)
   */
...
function limpiarError(campo) {
  ...
  // Marcar como válido solo si tiene contenido
